...
\begin{align*}
	...
	f_X(t) & = \frac{d}{dt} F_{X_1}(t) \cdot F_{X_2}(t) = \frac{d}{dt} t^2 \cdot \mathds{1}_{0 \leq t \leq 1} = 2t \cdot \mathds{1}_{0 \leq t \leq 1}
\end{align*}
...
\[f_P(p) = \mathds{1}_{p \in [0,1]} \quad f_{H | P}(h \mid p) = \frac{1}{p} \cdot \mathds{1}_{h \in [0,p]}\]

\noindent
Somit ist:
\[f_{P, H} (p, h) = f_P(p) \cdot f_{H | P}(h \mid p) = \frac{1}{p} \cdot \mathds{1}_{0 \leq h \leq p \leq 1}\]
